...
public class ArtefakMatriks_1402024054jian {
    ...
    public static void main(String[] Jian) {
        ...
        simbolChar[0][0] = inputPengguna.nextLine().charAt(0);
        System.out.print("Masukan simbol ke-2: ");
        simbolChar[0][1] = inputPengguna.nextLine().charAt(0);
        System.out.print("Masukan simbol ke-3: ");
        simbolChar[0][2] = inputPengguna.nextLine().charAt(0);
        System.out.print("Masukan simbol ke-4: ");
        simbolChar[1][0] = inputPengguna.nextLine().charAt(0);
        System.out.print("Masukan simbol ke-5: ");
        simbolChar[1][1] = inputPengguna.nextLine().charAt(0);
        System.out.print("Masukan simbol ke-6: ");
        simbolChar[1][2] = inputPengguna.nextLine().charAt(0);
        System.out.print("Masukan simbol ke-7: ");
        simbolChar[2][0] = inputPengguna.nextLine().charAt(0);
        System.out.print("Masukan simbol ke-8: ");
        simbolChar[2][1] = inputPengguna.nextLine().charAt(0);
        System.out.print("Masukan simbol ke-9: ");
        simbolChar[2][2] = inputPengguna.nextLine().charAt(0);

        System.out.println("===============================================================================================================================================");
        System.out.println("Artefak Matriks berordo 3x3 Berhasil Diaktifkan: ");
        System.out.println(Arrays.toString(simbolChar[0]));
        System.out.println(Arrays.toString(simbolChar[1]));
        System.out.println(Arrays.toString(simbolChar[2]));
        System.out.println("===============================================================================================================================================");
        ...
        simbolCharAscii[0][0][0] = simbolChar[0][0];
        simbolCharAscii[0][0][1] = simbolChar[0][1];
        simbolCharAscii[0][0][2] = simbolChar[0][2];
        simbolCharAscii[0][1][0] = simbolChar[1][0];
        simbolCharAscii[0][1][1] = simbolChar[1][1];
        simbolCharAscii[0][1][2] = simbolChar[1][2];
        simbolCharAscii[0][2][0] = simbolChar[2][0];
        simbolCharAscii[0][2][1] = simbolChar[2][1];
        simbolCharAscii[0][2][2] = simbolChar[2][2];
        ...
        minor[0][0][0] = (simbolChar[1][1] * simbolChar[2][2]) - (simbolChar[1][2] * simbolChar[2][1]);
        minor[0][0][1] = (simbolChar[1][0] * simbolChar[2][2]) - (simbolChar[1][2] * simbolChar[2][0]);
        minor[0][0][2] = (simbolChar[1][0] * simbolChar[2][1]) - (simbolChar[1][1] * simbolChar[2][0]);

        minor[0][1][0] = (simbolChar[0][1] * simbolChar[2][2]) - (simbolChar[0][2] * simbolChar[2][1]);
        minor[0][1][1] = (simbolChar[0][0] * simbolChar[2][2]) - (simbolChar[0][2] * simbolChar[2][0]);
        minor[0][1][2] = (simbolChar[0][0] * simbolChar[2][1]) - (simbolChar[0][1] * simbolChar[2][0]);

        minor[0][2][0] = (simbolChar[0][1] * simbolChar[1][2]) - (simbolChar[0][2] * simbolChar[1][1]);
        minor[0][2][1] = (simbolChar[0][0] * simbolChar[1][2]) - (simbolChar[0][2] * simbolChar[1][0]);
        minor[0][2][2] = (simbolChar[0][0] * simbolChar[1][1]) - (simbolChar[0][1] * simbolChar[1][0]);
