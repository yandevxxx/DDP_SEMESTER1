...
public class awewe {
    ...
    public static void main(String[] jian) {
        ...
        double[][] listAcademyStatistickAttackPasif = {
            {
                45 + 45 * 0.5, //ini 0.5 karna dari hints Unique Equipment mempunyai pasif yang menambah +50% atk
                99 + 99 * 0.5 //ini 0.5 karna dari hints Unique Equipment mempunyai pasif yang menambah +50% atk
            },
            {
                105 + 105 * 0.5, //ini 0.5 karna dari hints Unique Equipment mempunyai pasif yang menambah +50% atk
                69 + 69 * 0.5 //ini 0.5 karna dari hints Unique Equipment mempunyai pasif yang menambah +50% atk
            }
        };
